# OpenRocket 3D Flight Visualizer — Technical Documentation

Comprehensive architectural and engineering documentation for the **OpenRocket 3D Flight Visualizer**, an interactive 3D WebGL flight replay and trajectory visualizer for OpenRocket simulation CSV exports.
...
├── LICENSE                    # MIT License
└── sim1.csv                   # Default sample OpenRocket simulation CSV export
```
